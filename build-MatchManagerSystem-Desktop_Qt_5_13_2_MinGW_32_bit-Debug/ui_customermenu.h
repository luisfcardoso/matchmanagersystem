...
public:
    ...
    void setupUi(QDialog *CustomerMenu)
    {
        ...
        btn_delete_user = new QPushButton(verticalLayoutWidget);
        btn_delete_user->setObjectName(QString::fromUtf8("btn_delete_user"));
        btn_delete_user->setMinimumSize(QSize(0, 120));
        btn_delete_user->setSizeIncrement(QSize(0, 0));
        btn_delete_user->setFont(font1);

        gridLayout_3->addWidget(btn_delete_user, 1, 0, 1, 1);
        ...
        QWidget::setTabOrder(btn_bought_tickets, btn_delete_user);
        QWidget::setTabOrder(btn_delete_user, btn_close_customer_menu);
    ...
    void retranslateUi(QDialog *CustomerMenu)
    {
        ...
        btn_delete_user->setText(QCoreApplication::translate("CustomerMenu", "Excluir Cadastro", nullptr));
